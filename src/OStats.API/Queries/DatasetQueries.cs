...
{
    public static readonly Func<Context, string, Guid, Task<Dataset?>> GetDatasetByIdAsync = EF.CompileAsyncQuery(
    ...
    public static readonly Func<Context, Guid, Task<List<User>>> GetDatasetUsersAsync = EF.CompileAsyncQuery(
        (Context context, Guid datasetId) =>
            context.DatasetsUsersAccessLevels
